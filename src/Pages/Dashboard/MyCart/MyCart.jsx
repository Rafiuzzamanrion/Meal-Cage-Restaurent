...
const MyCart = () => {
    ...
    return (
        <div className="w-full px-4 lg:px-8 pb-16 pt-28 min-h-screen bg-dark-900 transition-all">
            <Helmet>
                <title>MealCage | My cart</title>
            </Helmet>

            <div className="max-w-5xl mx-auto">
                <div className="mb-12 flex flex-col md:flex-row justify-between items-center bg-dark-800 border border-white/10 shadow-2xl shadow-black/50 p-8 rounded-2xl"
                    data-aos="fade-down"
